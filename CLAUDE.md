...
- [x] **casimir-tools PyPI package** (v0.1.7 live — pypi.org/project/casimir-tools/)
...
Indexed as **spaceship_bubble** (557 symbols, 1192 relationships, 34 execution flows).
> Index goes stale after commits — run `npx gitnexus analyze` to refresh.

## Tools Quick Reference

| Tool | When to use | Command |
|------|-------------|---------|
| `query` | Find code by concept | `gitnexus_query({query: "concept"})` |
| `context` | 360° view of one symbol | `gitnexus_context({name: "X"})` |
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/spaceship_bubble/context` | Codebase overview |
| `gitnexus://repo/spaceship_bubble/processes` | All execution flows |
| `gitnexus://repo/spaceship_bubble/process/{name}` | Step-by-step trace |
...
Auto-updates on every file edit. Use BEFORE Grep/Glob/Read. Fall back to Grep only when graph can't answer.
